# nvim-treesitter-queries-strace

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-strace/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-strace/actions/workflows/validate.yml)

Neovim tree-sitter queries for **strace**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-strace",
...
- [ ] Changes are scoped to `strace` — do not include files for other languages
